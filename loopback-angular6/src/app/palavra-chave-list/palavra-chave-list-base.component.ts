...
import { PalavraChave , PalavraChaveApi } from "../shared/sdk";
import { PalavraChaveEditComponent } from "../palavra-chave-edit/palavra-chave-edit.component";

export class PalavraChaveListBaseComponent implements OnInit {
	principal: PalavraChave;
	listaBase:PalavraChave[]
	idPrincipal: number;
	...
	getComponente() : any {
		return PalavraChaveEditComponent
	}
